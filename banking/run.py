#!/usr/bin/env python3
"""
Training script for the Banking customer support topic classification task.
...
Usage:
    ...
    python -m banking.run \
        ...
        --save_path results/banking_eval
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='ACE System - Banking Topic Classification')
    
    # Task configuration
    parser.add_argument("--task_name", type=str, default="banking",
                        help="Name of the task (default: 'banking')")
    ...
    parser.add_argument("--config_path", type=str, 
                        default="./banking/data/task_config.json",
...
def preprocess_data(task_name, config, mode):
    """
    Load training and test data for the banking task.
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"ACE SYSTEM - BANKING TOPIC CLASSIFICATION")
    print(f"{'='*60}")
